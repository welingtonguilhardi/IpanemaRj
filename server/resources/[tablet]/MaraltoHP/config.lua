...
cfg.imageUploadWebhook = "https://discord.com/api/webhooks/1009178828247138526/h_UZeMdzGji67NBrJBw2KH8tkel3KQd4dO3M9-SV7KX7eA2AvrKcLmtus_rjvK3w5TIp"
...
cfg.atendimentos = {
    ...
    soundCoords = {-823.05, -1229.76, 7.34},
    soundMaxDist = 13
}

-- # Configuração do gesso
cfg.gesso = {
    coords = {-795.0,-1215.94,8.32,146.19},
    radius = 10,
