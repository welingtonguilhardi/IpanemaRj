...
-----------------------------------------------------------------------------------------------------------------------------------------
-- SHOPS:restauranteStore
-----------------------------------------------------------------------------------------------------------------------------------------
AddEventHandler("shops:restauranteStore",function()
	SendNUIMessage({ action = "showNUI", name = tostring("restauranteStore"), type = vSERVER.getShopType("restauranteStore") })
	SetNuiFocus(true,true)
end)
-----------------------------------------------------------------------------------------------------------------------------------------
-- SHOPS:WATERMACHINE
