...
local webhookDepositar = "https://discord.com/api/webhooks/1009167574761750609/nuckhbmBUMMmHc90Vbl7xGhXgvHWTw3hgf_WE0r72GABWV8LwDxx3Yk_oxCsBwwk1sjx"
local webhookSacar = "https://discord.com/api/webhooks/1009167777724121218/Uz9t9zHh-q2q1Eur6n6pCmONt85oMKc7rNOrDCZMDJ-3KzmMxAUo3RcQ5WfFNXcMKKPx"
local webhookPTrans = "https://discord.com/api/webhooks/1009167888134975498/066wObhmj153leyntwdHy2lOMJNIietgMLccRAbUvOR0RGj0XprJlvg7JIhon-Zj-tbs"
...
AddEventHandler('banco:depositar', function(amount)
	...
	if amount == nil or amount <= 0 or amount > vRP.getInventoryItemAmount(user_id, "dollars") then
