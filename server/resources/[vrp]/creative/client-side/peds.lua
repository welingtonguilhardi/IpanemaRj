...
local pedList = {
	...
	{ -- Mecanico Gordão 1
   		distance = 10,
   		coords = { 840.76,-986.95,26.49,85.34 },
   		model = { 0x04430687,"csb_car3guy1" },
   		anim = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
    },
	{ -- Ammu-Nation Store
		distance = 12,
...
--	},
	...
	{ -- Hospital Pharmacy Store
		distance = 15,
		coords = { -817.0,-1245.39,7.34,41.48 },
	...
	{ -- Restaurante
		distance = 15,
		coords = { -172.01,295.03,93.77,274.86 },
...
--		model = { 0x6CCFE08A,"ig_clay" },
	...
	{ -- ArsenalRP
		distance = 10,
		coords = { 586.23,13.27,90.66,337.49},
		model = { 0x63858A4A,"s_m_m_armoured_02" },
		anim = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
	},
	{ -- Arsenal
		distance = 10,
		coords = { -948.28,-2047.63,9.41,314.11 },
		model = { 0x63858A4A,"s_m_m_armoured_02" },
		anim = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
	},
	{ -- PoliciaBOPE
		distance = 10,
		coords = { -917.85,-2032.51,9.41,142.57 },
